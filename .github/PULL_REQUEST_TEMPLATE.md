<!--
Thank you for contributing to Stampp!
...
<!-- Link related issues using closing keywords where appropriate. -->
...
- [ ] I have run `vp run check` and it passes.
- [ ] I have run `vp run typecheck` and it passes.
- [ ] I have run `vp run test` and it passes.
- [ ] I have run `vp run build` and it passes.
