...
type _CoercedEnvSchema_52231a22 = CoercedEnvSchema;
...
type _EnvSchemaAsStrings_52231a22 = EnvSchemaAsStrings;

export type PublicCoercedEnvSchema = Readonly<Pick<CoercedEnvSchema, 'BETTER_AUTH_URL' | 'MAIL_FROM' | 'MAIL_MODE' | 'SMTP_HOST' | 'SMTP_PORT' | 'STORAGE_ENDPOINT' | 'STORAGE_BUCKET' | 'STORAGE_REGION' | 'GOOGLE_CLIENT_ID' | 'GITHUB_CLIENT_ID' | 'APP_ENV' | 'PUBLIC_APP_URL'>>;
